  ...
  return (
    <section className="relative flex h-screen w-full flex-col items-center justify-center bg-gradient-to-b from-sky-400 to-sky-700">
      ...
      <div className="text-center">
        <h1 className="text-5xl font-bold text-indigo-100 drop-shadow-md md:text-7xl lg:text-8xl">
          Andrew Gomes
        </h1>

        {/* Subtítulo (opcional) */}
        <p className="mt-4 text-center text-xl text-indigo-100 drop-shadow-md md:text-end md:text-3xl lg:text-end lg:text-4xl">
